    ...
    <div className="relative h-[calc(100vh-64px)] flex flex-col items-center justify-center text-center px-4 overflow-hidden transition-colors duration-1000 bg-gradient-to-b from-sky-200 to-sky-50 dark:from-[#0f172a] dark:to-[#050b14]">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          <Link href="/blog" className="hover-glitch px-6 py-3 bg-yellow-400 text-black font-pixel-bold-cn text-sm md:text-base border-2 border-black dark:border-white rounded-sm retro-shadow-yellow hover:shadow-none transition-all w-full sm:w-auto text-center">
            读读文章
          </Link>
