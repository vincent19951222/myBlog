        ...
        <div className="hidden md:flex items-center gap-8">
          {navItems.map((item) => (
            <Link
              key={item.id}
              href={item.id}
              className={`flex items-center gap-2 font-pixel-bold-cn text-xl transition-colors ${isActive(item.id)
          ...
          <div className="flex flex-col gap-6 items-center w-full">
            {navItems.map((item) => (
              <Link
                ...
                className={`flex items-center gap-3 font-pixel-bold-cn text-2xl w-full justify-center py-2 border-b border-slate-100 dark:border-slate-800 ${isActive(item.id)
                    ? 'text-yellow-600 dark:text-yellow-400'
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            ...
            <nav className="flex flex-col space-y-3">
              ...
              <Link href="/blog" className="text-slate-600 dark:text-gray-400 hover:text-yellow-600 dark:hover:text-yellow-400 transition-colors text-sm font-medium hover:translate-x-1 duration-200 text-left">看看博客</Link>
